...
import { entity, Entities, Entity, ValueProto } from '@google-cloud/datastore/build/src/entity';
import Key = entity.Key;
export { Entity, Key };
import { PropertyFilter, and, or } from '@google-cloud/datastore/build/src/filter';
export { PropertyFilter, and, or };
import { GetIndexesCallback, GetIndexesOptions, GetIndexesResponse, Index } from '@google-cloud/datastore/build/src/index-class';
import { Query } from '@google-cloud/datastore/build/src/query';
import { DatastoreRequest, CommitCallback, CommitResponse, SaveCallback, SaveResponse } from '@google-cloud/datastore/build/src/request';
...
export { v1 };
export { DatastoreClient, DatastoreAdminClient } from '@google-cloud/datastore/build/src/v1';
